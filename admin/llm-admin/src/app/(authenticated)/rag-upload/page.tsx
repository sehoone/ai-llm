        ...
        <div className="space-y-4">
             <Card>
                ...
                <CardContent className="text-sm space-y-2 text-muted-foreground">
                    <p>
                        Upload documents here to include them in the RAG knowledge base.
                        Supported formats are <strong>PDF</strong>, <strong>Microsoft Word (DOCX)</strong>, and plain text files.
                    </p>
                    <p>
                        <strong>RAG Key:</strong> This is the main identifier for your document collection. Use this same key in the "Natural Language Search" page to search within these documents.
                    </p>
                    <p>
                        <strong>RAG Type:</strong> User Isolated means only you can see these documents. Chatbot Shared means they are available globally (e.g. for all users of a specific chatbot).
                    </p>
                </CardContent>
             </Card>
        </div>
