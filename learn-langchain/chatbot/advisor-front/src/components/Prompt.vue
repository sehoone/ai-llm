        ...
        <v-card min-width="300" max-width="500">
          ...
          <v-list>
            ...
            <template v-for="(prompt, idx) in prompts" :key="prompt.id">
              <v-list-item active-color="primary" v-if="editingPrompt && editingPrompt.id === prompt.id">
                <div class="d-flex flex-row" :style="{ marginTop: '5px' }">
                  ...
                  <div>
                    <div class="d-flex flex-column">
                      <v-btn icon="done" variant="text" :loading="editingPrompt.updating" @click="updatePrompt(idx)">
                      </v-btn>
                      <v-btn icon="close" variant="text" @click="cancelEditPrompt()"> </v-btn>
                    </div>
                  </div>
                </div>
              </v-list-item>
              ...
              >
                ...
                <template v-slot:append>
                  <v-btn icon="edit" size="small" variant="text" @click="editPrompt(idx)"> </v-btn>
                  <v-btn
                    icon="delete"
                    size="small"
                    variant="text"
            ...
            <v-list-item>
              <v-btn variant="text" block :loading="submittingNewPrompt" @click="addPrompt()">
