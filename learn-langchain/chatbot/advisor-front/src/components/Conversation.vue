...
// import { addConversation, genTitle } from '@/composables/useConversation';
...
const fetchReply = async (message) => {
  ...
  try {
    await fetchEventSource('/api/chatbot/stream-conversation', {
      signal: ctrl.signal,
      method: 'POST',
      headers: {
  ...
  <v-footer app class="footer">
    <div class="px-md-16 w-100 d-flex flex-column">
      ...
      <v-toolbar density="comfortable" color="transparent">
        ...
        <v-switch v-model="enableWebSearch" inline hide-details color="primary" :label="$t('webSearch')"></v-switch>
        <v-spacer></v-spacer>
        <div class="d-flex align-center">
