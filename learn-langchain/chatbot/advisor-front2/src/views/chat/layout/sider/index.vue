...
const searchValue = ref(siderStore.searchQuery)
watch(searchValue, (newValue) => {
  siderStore.setChatSiderSearchQuery(newValue)
}, {
  immediate: true,
})
    ...
    <div class="flex flex-col h-full" :style="mobileSafeArea">
      <main class="flex flex-col flex-1 min-h-0">
        ...
        <div class="pl-4 pr-4 pb-4 pt-1 border-b-2 border-[rgb(239,239,245)]">
          <NInput NInput v-model:value="searchValue" @input="searchValue = $event" size="large" :placeholder="$t('chat.searchPlaceholder')">
            <template #suffix>
