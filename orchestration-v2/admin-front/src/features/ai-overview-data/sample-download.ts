const SAMPLE_DOCUMENTS = [
  {
    ...
    "source_url": "https://edu.company.com/courses/python-basic"
  },
  {
    "title": "Python 데이터 분석 (pandas, numpy)",
    ...
    "source_url": "https://edu.company.com/courses/python-data-analysis"
  },
  {
    "title": "AWS 클라우드 입문",
    ...
    "source_url": "https://edu.company.com/courses/aws-intro"
  },
  {
    "title": "AWS Solutions Architect Associate 자격증 대비",
    ...
    "source_url": "https://edu.company.com/courses/aws-saa"
  },
  {
    ...
    "source_url": "https://edu.company.com/courses/docker-k8s"
  },
  {
    "title": "LLM 활용 및 프롬프트 엔지니어링",
    ...
    "source_url": "https://edu.company.com/courses/llm-prompt"
  },
  {
    ...
    "source_url": "https://edu.company.com/courses/spring-boot"
  },
  {
    ...
    "source_url": "https://edu.company.com/courses/react"
  },
  {
    "title": "데이터베이스 설계 및 SQL 심화",
    ...
    "source_url": "https://edu.company.com/courses/sql-advanced"
  },
  {
    "title": "정보보안 기초 및 개인정보보호",
    "content": "과정 소개:\n임직원 모두가 알아야 할 정보보안 기본 수칙과 개인정보 보호법 준수 사항을 학습하는 필수 과정입니다. 연 1회 이수 의무입니다.\n\n학습 목표:\n- 정보보안 위협 유형 이해 (피싱, 랜섬웨어, 사회공학)\n- 안전한 비밀번호 관리 및 PC 보안\n- 개인정보 수집·처리·파기 원칙\n- 개인정보보호법 주요 조항 이해\n- 보안 사고 발생 시 대응 절차\n\n커리큘럼:\n1강 (1시간): 최신 보안 위협 동향\n2강 (1시간): 임직원 보안 수칙\n3강 (1시간): 개인정보보호법 개요\n4강 (1시간): 개인정보 처리 실무\n5강 (30분): 모의 피싱 대응 훈련\n6강 (30분): 평가 및 수료\n\n수강 대상: 전 임직원 (필수 이수)\n교육 기간: 1일 (총 5시간)\n교육 형태: 온라인 자기학습\n이수 기준: 80점 이상 (재응시 가능)\n이수 마감: 매년 12월 31일",
    "source_url": "https://edu.company.com/courses/security-basic"
  },
  {
    "title": "신입사원 직무 기초 교육",
    ...
    "source_url": "https://edu.company.com/courses/new-employee"
  },
  {
    "title": "리더십 역량 개발 (팀장급)",
    ...
    "source_url": "https://edu.company.com/courses/leadership"
  },
  {
    ...
    "source_url": "https://edu.company.com/courses/business-english"
  },
  {
    "title": "프로젝트 관리 (PMP 기반)",
    ...
    "source_url": "https://edu.company.com/courses/pmp"
  },
  {
    "title": "커뮤니케이션 스킬 향상",
    ...
    "source_url": "https://edu.company.com/courses/communication"
  },
  {
    "title": "데이터 기반 의사결정",
    ...
    "source_url": "https://edu.company.com/courses/data-decision"
  },
  {
    "title": "애자일/스크럼 실무 적용",
    ...
    "source_url": "https://edu.company.com/courses/agile-scrum"
  },
  {
    ...
    "source_url": "https://edu.company.com/courses/sexual-harassment-prevention"
  },
  {
    "title": "Excel 업무 활용 고급",
    ...
    "source_url": "https://edu.company.com/courses/excel-advanced"
  },
  {
    ...
    "source_url": "https://edu.company.com/courses/design-thinking"
  },
  {
    "title": "Git & GitHub 버전 관리 실무",
    ...
    "source_url": "https://edu.company.com/courses/git-github"
  }
]

export function downloadSampleJson() {
  const blob = new Blob([JSON.stringify(SAMPLE_DOCUMENTS, null, 2)], { type: 'application/json' })
  const url = URL.createObjectURL(blob)
  const a = document.createElement('a')
  a.href = url
  a.download = 'ai-overview-sample.json'
  a.click()
