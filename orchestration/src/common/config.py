...
class Settings:
    ...
    def __init__(self):
        ...
        self.JWT_REFRESH_TOKEN_EXPIRE_MINUTES = int(os.getenv("JWT_REFRESH_TOKEN_EXPIRE_MINUTES", "10080"))  # 7 days
        ...
        self.POSTGRES_SCHEMA = os.getenv("POSTGRES_SCHEMA", "llmonl")
